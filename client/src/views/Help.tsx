  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-5">
        <h2 className="text-base font-semibold text-gray-200">Frequently asked questions</h2>
        {FAQ_GROUPS.map((group) => (
          <div key={group.title}>
            <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">{group.title}</h3>
